...
export default function LocationListPage() {
    ...
    useEffect(() => {
        const fetchLocation = async () => {
            try {
                ...
                console.log('API fetched and responses get', response.data.locations);
            } catch (error) {
                console.log(error);
            }
        };
    ...
    const handleUpdateLocation = async (id, updatedLocationName) => {
        ...
        console.log(result.data.updatedLocation)
            setLocation(result.data.updatedLocation);  // Assuming the API returns the updated list of locations
        } catch (error) {
            console.log(error);
        }
    };
    ...
    const handleSaveLocation = async (newLocation) => {
      try {
          ...
          console.log('the data get after added to database',result)
